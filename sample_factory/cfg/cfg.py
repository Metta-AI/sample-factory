...
def add_eval_args(parser):
    ...
    parser.add_argument("--no_render", default=False, help="Do not render the environment during evaluation")

    parser.add_argument("--save_video", default=False, help="Save video instead of rendering during evaluation")
    parser.add_argument(
        "--video_frames",
        default=1e9,
        type=int,
